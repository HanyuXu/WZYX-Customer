...
#define SelectColor        [UIColor colorWithRed:60/255.0f green:0/255.0f blue:132/255.0f alpha:1]
...
-(void)creatUI{
    ...
    //商品图片
    headImage = [[UIImageView alloc] initWithFrame:CGRectMake(20, 10, 80, 80)];
...
//    [whiteView addSubview:addBtn];
    ...
    buyBtn.frame = CGRectMake(0, whiteView.dwq_height-40, whiteView.frame.size.width, 40);
    [buyBtn setBackgroundColor:[UIColor colorWithRed:255/255.0f green:0/255.0f blue:0/255.0f alpha:1]];
