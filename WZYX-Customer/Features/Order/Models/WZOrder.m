...
+ (void)loadOrderListWithOrderState:(WZOrderState)orderState offset:(NSUInteger)offset limit:(NSUInteger)limit success:(void (^)(NSMutableArray *orders))successBlock failure:(void (^)(NSString *userInfo))failureBlock {
    ...
    NSDictionary *paramsDictionary = @{@"authToken" : authToken,
                                       @"orderState" : [NSNumber numberWithUnsignedInteger:orderState],
                                       @"offset" : [NSNumber numberWithUnsignedInteger:offset],
                                       @"limit" : [NSNumber numberWithUnsignedInteger:limit]};
...
+ (void)payOrder:(NSString *)orderId withPaymentMethod:(WZOrderPaymentMethod)method success:(void (^)(void))successBlock failure:(void (^)(NSString *userInfo))failureBlock {
    ...
    [manager POST:@"http://120.79.10.184:8080/order/pay_order" parameters:paramsDictionary progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSDictionary *responseDictionary = (NSDictionary *)responseObject;
        if ([responseDictionary[@"status"] intValue] == 0) {
            [NSThread sleepForTimeInterval:0.5];
            successBlock();
...
+ (void)refundOrder:(NSString *)orderId success:(void (^)(void))successBlock failure:(void (^)(NSString *userInfo))failureBlock {
    ...
    NSDictionary *paramsDictionary = @{@"authToken" : authToken,
                                       @"orderId" : orderId};
    [manager POST:@"http://120.79.10.184:8080/order/refund_order" parameters:paramsDictionary progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSDictionary *responseDictionary = (NSDictionary *)responseObject;
        if ([responseDictionary[@"status"] intValue] == 0) {
            [NSThread sleepForTimeInterval:0.5];
            successBlock();
...
+ (void)commentOrder:(NSString *)orderId withCommentText:(NSString *)commentText commentlevel:(NSInteger)commentLevel success:(void (^)(void))successBlock failure:(void (^)(NSString *userInfo))failureBlock {
    ...
    NSDictionary *paramsDictionary = @{@"authToken" : authToken,
                                       ...
                                       @"commentLevel" : [NSNumber numberWithInteger:commentLevel]};
    [manager POST:@"http://120.79.10.184:8080/wzyx_war/order/comment_order" parameters:paramsDictionary progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSDictionary *responseDictionary = (NSDictionary *)responseObject;
        if ([responseDictionary[@"status"] intValue] == 0) {
            [NSThread sleepForTimeInterval:0.5];
            successBlock();
