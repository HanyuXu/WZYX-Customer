...
#define kWZActivitySearchBarCellEdgeInsets UIEdgeInsetsMake(5,5,5,5)
...
- (UISearchBar *)searchBar {
    if (!_searchBar) {
        _searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 0, self.contentView.bounds.size.width, 50)];
